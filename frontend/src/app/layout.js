...
export const metadata = {
  title: 'NakshatraAI - Ancient Wisdom Meets Modern AI',
                ...
                <div className="grid md:grid-cols-4 gap-8">
                  ...
                  <div className="md:col-span-2">
                    <div className="flex items-center space-x-3 mb-6">
                      ...
                      <div>
                        <span className="text-xl font-bold text-light-text dark:text-dark-text">NakshatraAI</span>
                    ...
                    <p className="text-sm text-light-text-muted dark:text-dark-text-muted mt-6">
                      © 2025 NakshatraAI. All content generated by AstroAI Master.
                    </p>
                  </div>
